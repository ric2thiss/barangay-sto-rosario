...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 md:ml-64 p-6 transition-all duration-300">
        <header class="mb-6">
            ...
            <p class="text-gray-500 text-sm"><?= getGreeting($userName) ?> — Create local activities or review PSS imports.</p>
            <?php Breadcrumb([
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 mb-6">
            ...
            <p class="text-sm text-gray-600 mb-4">Duplicates are blocked when the same name and date already exist (local). PSS rows are imported automatically on the Attendance page and cannot be edited here.</p>
