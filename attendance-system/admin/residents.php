...
// Determine perPage from request
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center mb-6 space-y-4 sm:space-y-0">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <select name="per_page" id="per_page" form="searchForm" class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm" onchange="document.getElementById('searchForm').submit()">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($residents as $resident): ?>
                                ...
                                <tr class="bg-white hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900">
                                        <?= !empty($resident['purok']) ? 'Purok ' . htmlspecialchars($resident['purok']) . ', ' : '' ?><?= ucfirst($resident['barangay'] ?? '') ?>
                                    </td>
                ...
                <div class="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-600">
                    ...
                    <nav class="flex space-x-1" aria-label="Pagination">
                        ...
                        if ($perPage !== 10) {
                            $queryParams[] = 'per_page=' . urlencode($perPage);
                        }
                                ...
                                <div class="grid grid-cols-1 gap-8">
                                    ...
                                    <div class="lg:col-span-2 space-y-6 p-4 border rounded-lg bg-gray-50">
                                        ...
                                        <div class="flex flex-col sm:flex-row gap-6">
                                            ...
                                            <div class="flex-grow grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                                                <div class="col-span-1">
                                                    ...
                                                    <p class="text-sm text-gray-700"><span class="font-medium">Resident ID:</span> <span id="id"></span></p>
                                                    ...
                                                    <p class="text-sm text-gray-700"><span class="font-medium">Age:</span> <span id="age"></span></p>
                                                    <p class="text-sm text-gray-700"><span class="font-medium">Civil Status:</span> <span id="civil_status"></span></p>
                                                    <p class="text-sm text-gray-700"><span class="font-medium">Nationality:</span> <span id="nationality"></span></p>
                                                </div>

                                                <div class="col-span-1 space-y-4">
                                                    <div>
                                                        <h3 class="text-lg font-bold text-gray-900 mb-2">Contact & Occupation</h3>
                                                        <p class="text-sm text-gray-700"><span class="font-medium">Mobile No:</span> <span id="contact"></span></p>
                                                        <p class="text-sm text-gray-700"><span class="font-medium">Occupation:</span> <span id="occupation"></span></p>
                                                        <p class="text-sm text-gray-700"><span class="font-medium">Monthly Income:</span> <span id="monthly_income"></span></p>
                                                        <p class="text-sm text-gray-700"><span class="font-medium">Education:</span> <span id="educational_attainment"></span></p>
                                                    </div>

                                                    <div>
                                                        <h3 class="text-lg font-bold text-gray-900 mb-2">Residence Status</h3>
                                                        <p class="text-sm text-gray-700"><span class="font-medium">Address:</span> <span id="address_full"></span></p>
                                                        <p class="text-sm text-gray-700"><span class="font-medium">Household Size:</span> <span id="total_household"></span></p>
                                                        <p class="text-sm text-gray-700"><span class="font-medium">Voters Status:</span> <span id="voters_status"></span></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-6 border-t pt-4">
                                            <details>
                                                <summary class="font-semibold text-gray-800 cursor-pointer hover:text-blue-600">▶ Show Additional Details</summary>
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 p-3 bg-white rounded-lg shadow-inner">
                                                    <div>
                                                        <h4 class="text-base font-bold text-gray-900">Health & Status</h4>
                                                        <p class="text-sm text-gray-700">PWD: <span id="is_pwd"></span></p>
                                                        <p class="text-sm text-gray-700">Deceased: <span id="is_deceased"></span></p>
                                                    </div>
                                                    <div>
                                                        <h4 class="text-base font-bold text-gray-900">System Records</h4>
                                                        <p class="text-sm text-gray-700">Record Created: <span id="created_at"></span></p>
                                                        <p class="text-sm text-gray-700">Last Updated: <span id="updated_at"></span></p>
                                                    </div>
                                                </div>
                                            </details>
                                        </div>
                                        ...
                                        <!-- Visitor Logs Table -->
                                        <div class="mt-6 border-t pt-4">
                                            <h2 class="text-xl font-semibold text-gray-800 border-b pb-2 mb-4">📋 Recent Visits & Services</h2>
                                                ...
                                                <table class="w-full text-left text-sm text-gray-700 divide-y divide-gray-200">
                                                    <thead class="bg-gray-100">
                                                        <tr>
                                                            ...
                                                            <th scope="col" class="px-4 py-3 font-semibold">Service Availed (Purpose)</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="visitor_logs_table_body" class="bg-white divide-y divide-gray-200">
