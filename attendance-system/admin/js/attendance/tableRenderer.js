...
export class TableRenderer {
    ...
    updateTable(attendance, resident) {
        ...
        // Determine if activity column should be hidden
        const activityHeader = document.querySelector('th.activity-col');
        const isHidden = activityHeader && activityHeader.classList.contains('hidden') ? 'hidden' : '';
        ...
        newRow.innerHTML = `
            ...
            <td class="px-3 py-3 whitespace-nowrap text-sm text-gray-600 activity-col ${isHidden}">${activityLabel}</td>
        `;
