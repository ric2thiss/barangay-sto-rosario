    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 md:ml-64 p-6 transition-all duration-300">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-1">Employee attendance</h2>
                <p class="text-sm text-gray-500 mb-4">Incomplete and action-needed rows are listed first. Existing logs are read-only; use "Fill gap" only for missing windows.</p>
                
                <!-- Inline Controls for this table -->
                <div class="flex flex-col lg:flex-row lg:flex-wrap lg:items-end gap-3 mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <!-- Search -->
                    <div class="flex-1 min-w-[200px]">
                        <label for="table-search" class="block text-xs font-medium text-gray-600 mb-1">Search employee</label>
                        <div class="relative">
                            <input type="text" id="table-search" placeholder="Type employee name…" class="w-full py-2 pl-9 pr-3 text-sm border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                            <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                        </div>
                    </div>
                    <!-- Date From -->
                    <div>
                        <label for="table-date-from" class="block text-xs font-medium text-gray-600 mb-1">From</label>
                        <input type="date" id="table-date-from" class="block w-full md:w-40 py-2 px-3 text-sm border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <!-- Date To -->
                    <div>
                        <label for="table-date-to" class="block text-xs font-medium text-gray-600 mb-1">To</label>
                        <input type="date" id="table-date-to" class="block w-full md:w-40 py-2 px-3 text-sm border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <!-- Status Filter -->
                    <div>
                        <label for="table-status" class="block text-xs font-medium text-gray-600 mb-1">Status</label>
                        <select id="table-status" class="py-2 pl-3 pr-8 text-sm border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                            <option value="all">All</option>
                            <option value="Incomplete">Incomplete</option>
                            <option value="Absent">Absent</option>
                            <option value="Late">Late</option>
                    ...
                    <!-- Per Page -->
                    <div>
                        <label for="table-per-page" class="block text-xs font-medium text-gray-600 mb-1">Show</label>
                        <select id="table-per-page" class="py-2 pl-3 pr-8 text-sm border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <!-- Apply -->
                    <div>
                        <button type="button" id="table-apply-filters" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg text-sm shadow-sm">
                            Apply
                        </button>
                    </div>
                </div>
