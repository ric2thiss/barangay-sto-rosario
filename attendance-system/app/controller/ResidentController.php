...
class ResidentController
{
    ...
    /**
     * Lightweight: only the fields needed for face recognition (id, names, photo).
     * Skips residents without photos at the DB level.
     */
    public function getResidentsForFaceRecognition(): array
    {
        return $this->residentRepository->getForFaceRecognition();
    }
