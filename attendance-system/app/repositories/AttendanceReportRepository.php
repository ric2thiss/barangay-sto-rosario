...
class AttendanceReportRepository {
    ...
    public function getEventRosterPage(
        ...
        // Query officials from profiling DB via its own connection
        ...
        if ($profilingPdo) {
            ...
            ";
            $stmt = $profilingPdo->prepare($countSql);
            ...
            ";
            $stmt = $profilingPdo->prepare($listSql);
