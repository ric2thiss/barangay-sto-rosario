 ...
 * 
 * Browser: http://localhost/attendance-system/database/migrations/run_migration.php
 * CLI: php database/migrations/run_migration.php
 */
...
echo "<h1>Visitor Logs Table Migration</h1>";
echo "<pre>";
...
try {
    ...
    $sqlFile = __DIR__ . '/create_visitor_logs_table.sql';
    ...
    if ($errorCount === 0) {
        ...
        echo "\nYou can now use the visitor logging system.\n";
    } else {
