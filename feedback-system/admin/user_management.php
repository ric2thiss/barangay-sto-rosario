...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $where_conditions[] = "(username LIKE '%$search%' OR email LIKE '%$search%' OR first_name LIKE '%$search%' OR surname LIKE '%$search%' OR purok LIKE '%$search%')";
}
...
$users_sql = "SELECT * FROM `profiling-system`.residents $where_clause ORDER BY created_at DESC LIMIT $per_page OFFSET $offset";
$users_result = $conn->query($users_sql);

// Get user statistics
$stats_sql = "SELECT 
                COUNT(*) as total_users,
                SUM(CASE WHEN user_role IN ('admin', 'staff') THEN 1 ELSE 0 END) as admin_count,
                COUNT(DISTINCT purok) as purok_count,
                MIN(created_at) as first_user_created
              FROM `profiling-system`.residents";
...
?>
                ...
                <head>
                    ...
                    <title>User Management - Resident Feedback and Survey System</title>
                ...
                <body>
                        ...
                        <div class="modal">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="alert alert-success"
                                    ...
                                    <i class="fas fa-info-circle"></i> This form creates <strong>Regular User
                                        Accounts</strong>. These accounts will have access to submit feedback and view
                                    their submissions.
                                </div>
                                ...
                                <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
                                    ...
                                    <div class="row mb-3" style="display: flex; flex-wrap: wrap; margin-bottom: 20px;">
                                        <div style="flex: 1; min-width: 250px; padding: 0 10px;">
                                            ...
                                            <input type="text"
                                                class="form-control <?php echo isset($create_user_errors['first_name']) ? 'is-invalid' : ''; ?>"
                                                id="firstname" name="firstname"
                                                value="<?php echo htmlspecialchars($create_user_values['first_name'] ?? ''); ?>"
                                                required>
                                            <?php if (isset($create_user_errors['first_name'])): ?>
                                                <div class="invalid-feedback">
                                                    <?php echo $create_user_errors['first_name']; ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div style="flex: 1; min-width: 250px; padding: 0 10px;">
                                            ...
                                            <input type="text"
                                                class="form-control <?php echo isset($create_user_errors['surname']) ? 'is-invalid' : ''; ?>"
                                                id="lastname" name="lastname"
                                                value="<?php echo htmlspecialchars($create_user_values['surname'] ?? ''); ?>"
                                                required>
                                            <?php if (isset($create_user_errors['surname'])): ?>
                                                <div class="invalid-feedback">
                                                    <?php echo $create_user_errors['surname']; ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3" style="display: flex; flex-wrap: wrap; margin-bottom: 20px;">
                                        <div style="flex: 1; min-width: 300px; padding: 0 10px;">
                                            ...
                                            <input type="text"
                                                ...
                                                id="purok" name="purok"
                                                value="<?php echo htmlspecialchars($create_user_values['purok'] ?? ''); ?>"
                                                required>
                                            ...
                                            <?php endif; ?>
                                            <small class="text-muted">Enter the purok/zone where the user
                                                resides</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3" style="display: flex; flex-wrap: wrap; margin-bottom: 20px;">
                                        <div style="flex: 1; min-width: 300px; padding: 0 10px;">
                                            ...
                                            <input type="text"
                                                ...
                                                value="<?php echo htmlspecialchars($create_user_values['username'] ?? ''); ?>"
                                                required>
                            ...
                            <div class="modal-header">
                                <h3>
                                    ...
                                    <span class="user-badge" id="editUserBadge">
                                        <?php echo isset($edit_user_values['user_role']) ? strtoupper($edit_user_values['user_role']) :
                                            (isset($edit_user_data['user_role']) ? strtoupper($edit_user_data['user_role']) : 'USER'); ?>
                                    </span>
                                </h3>
                                ...
                                <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
                                    ...
                                    <div class="row mb-3" style="display: flex; flex-wrap: wrap; margin-bottom: 20px;">
                                        <div style="flex: 1; min-width: 250px; padding: 0 10px;">
                                            ...
                                            <input type="text"
                                                class="form-control <?php echo isset($edit_user_errors['first_name']) ? 'is-invalid' : ''; ?>"
                                                id="edit_firstname" name="firstname"
                                                value="<?php echo htmlspecialchars($edit_user_values['first_name'] ?? $edit_user_data['first_name'] ?? ''); ?>"
                                                required>
                                            <?php if (isset($edit_user_errors['first_name'])): ?>
                                                <div class="invalid-feedback">
                                                    <?php echo $edit_user_errors['first_name']; ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div style="flex: 1; min-width: 250px; padding: 0 10px;">
                                            ...
                                            <input type="text"
                                                class="form-control <?php echo isset($edit_user_errors['surname']) ? 'is-invalid' : ''; ?>"
                                                id="edit_lastname" name="lastname"
                                                value="<?php echo htmlspecialchars($edit_user_values['surname'] ?? $edit_user_data['surname'] ?? ''); ?>"
                                                required>
                                            <?php if (isset($edit_user_errors['surname'])): ?>
                                                <div class="invalid-feedback">
                                                    <?php echo $edit_user_errors['surname']; ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3" style="display: flex; flex-wrap: wrap; margin-bottom: 20px;">
                                        ...
                                        <div style="flex: 1; min-width: 200px; padding: 0 10px;">
                                            ...
                                            <select class="user-type-select" id="edit_user_type" name="user_type">
                                                <option value="user" <?php echo (($edit_user_values['user_role'] ?? $edit_user_data['user_role'] ?? '') == 'user') ? 'selected' : ''; ?>>
                                                    User</option>
                                                <option value="admin" <?php echo (($edit_user_values['user_role'] ?? $edit_user_data['user_role'] ?? '') == 'admin') ? 'selected' : ''; ?>>
                                                    Admin</option>
                                            </select>
                                            <?php if (isset($edit_user_errors['user_role'])): ?>
                                                <div class="invalid-feedback">
                                                    <?php echo $edit_user_errors['user_role']; ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="change-password-container">
                                        <div class="change-password-toggle" onclick="togglePasswordFields()">
                                            <input type="checkbox" id="change_password" name="change_password" value="1"
                                                <?php echo (isset($edit_user_values['change_password']) && $edit_user_values['change_password']) ? 'checked' : ''; ?>>
                                    ...
                                    <div class="alert alert-success"
                                        ...
                                        <?php if (isset($edit_user_data['updated_at']) && $edit_user_data['updated_at'] != '0000-00-00 00:00:00'): ?>
                                            <br>Last updated on
                                            <?php echo date('F j, Y', strtotime($edit_user_data['updated_at'])); ?>
                                        <?php endif; ?>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="modal modal-danger">
                            ...
                            <div class="modal-body">
                                <div class="delete-confirmation">
                                    ...
                                    <p>This action <strong>cannot be undone</strong> and will permanently remove the
                                        account and all associated feedback submissions.</p>
                                    ...
                                    <div class="warning-note">
                                        <i class="fas fa-exclamation-circle"></i>
                                        <strong>Warning:</strong> Deleting this user will permanently remove their
                                        account and all their feedback submissions. This action is irreversible.
                                    </div>
                    ...
                    <nav class="sidebar" id="sidebar">
                        ...
                        <div class="login-indicator">
                            <div class="user-info"
                                data-tooltip="<?php echo htmlspecialchars($_SESSION['username']); ?>">
                                ...
                                <div class="user-details">
                                    ...
                                    <div class="user-role">
                                        <?php echo (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'superadmin') ? 'Super Admin' : 'Admin'; ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="menu-items">
                            ...
                            <li class="menu-item">
                                <a href="system_logs.php"
                                    class="menu-link <?php echo basename($_SERVER['PHP_SELF']) == 'system_logs.php' ? 'active' : ''; ?>"
                    ...
                    <main class="main-content" id="mainContent">
                            ...
                            <div class="user-cards-mobile" id="mobileUserView">
                                ...
                                if ($users_result->num_rows > 0):
                                    ...
                                    while ($user = $users_result->fetch_assoc()):
                                        ?>
                                        <div class="user-card-mobile-item" id="mobile-user-<?php echo $user['id']; ?>">
                                                ...
                                                <div class="mobile-user-detail-row">
                                                    ...
                                                    <div class="mobile-detail-value">
                                                        <?php if (!empty($user['purok'])): ?>
                                                            <span
                                                                class="badge badge-primary"><?php echo htmlspecialchars($user['purok']); ?></span>
                                                        <?php else: ?>
                                            ...
                                            <div class="mobile-user-card-footer">
                                                <div class="mobile-action-buttons">
                                                    <button type="button" class="mobile-action-btn btn-primary edit-user-btn"
                                                        ...
                                                        data-user-type="<?php echo htmlspecialchars($user['user_role']); ?>"
                                                        data-created-at="<?php echo htmlspecialchars($user['created_at']); ?>"
                                                        data-updated-at="<?php echo htmlspecialchars($user['updated_at'] ?? ''); ?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($user['user_role'] == 'admin' || $user['user_role'] == 'staff'): ?>
                                                            <span class="badge badge-warning"><?php echo ucfirst(htmlspecialchars($user['user_role'])); ?></span>
                                                        <?php else: ?>
                                                            <span class="badge badge-success">User</span>
                                                        <?php endif; ?>
                                                    </td>
                        ...
                        <div class="alert alert-success">
                            <i class="fas fa-info-circle"></i>
                            <div>
                                <strong>Note:</strong> This page shows all regular user accounts. Administrator accounts
                                are managed in the <a href="admin_settings.php"
                                    style="color: #1a317d; font-weight: 600;">Admin Settings</a> section.
                                Deleting a user will permanently remove their account and all associated feedback
                                submissions.
                            </div>
                        </div>
                    </main>
