    ...
    <style>
        * {
        ...
        .faq-answer {
            ...
            line-height: 1.6;
            padding-left: 26px;
            /* Align with text start of question name */
        }
...
<body>
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="header">
            <h1 class="page-title">
                <i class="fas fa-life-ring title-icon"></i>
                <?php echo __('help_title'); ?>
            </h1>
        ...
        <div class="settings-container">
            ...
            <div class="settings-card">
                <div class="settings-header">
                    <h2><i class="fas fa-question-circle"></i> <?php echo __('help_intro'); ?></h2>
                </div>
            ...
            <div class="settings-card">
                <div class="settings-header">
                    <h2><i class="fas fa-headset"></i> <?php echo __('contact_support'); ?></h2>
                </div>
                <div class="settings-body">
                    <div class="contact-content">
                        <p class="contact-desc"><?php echo __('contact_desc'); ?></p>
