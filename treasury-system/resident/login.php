        ...
        <div class="login-brand">
            ...
            <div class="login-brand-content">
                ...
                <div>
                    ...
                    <div class="login-feature-item"><span class="login-feature-dot"></span> Personal Transaction Log</div>
                </div>
            </div>
        </div>
            ...
            <div class="login-card">
                ...
                <form method="POST" autocomplete="off">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <a href="../treasurer_login.php" class="small text-decoration-none fw-bold" style="color: var(--brand-primary);">Treasurer Login</a>
                    </div>
