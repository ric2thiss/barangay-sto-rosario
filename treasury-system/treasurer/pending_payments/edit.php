...
<body>
    ...
    <script>
        ...
        function updateTotal() {
            ...
            // Wait, the user wants the "Amount" field to be base, and "Total" to be base + tax?
            // "AMOUNT-> 80 (YOU CAN JUST RENDER 50) THEN IN BIR TAX - 30 TOTAL - > 80"
            // So if user enters 50 in Amount and 30 in Tax, Total should be 80.
