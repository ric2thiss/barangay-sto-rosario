...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $paymentStmt = $conn->prepare("
        ...
        VALUES (?, ?, ?, 'Cedula', 'Cedula Issuance', ?, 0, ?, ?, ?, NOW())
    ");
