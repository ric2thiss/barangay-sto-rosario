...
<body>
    ...
    <div class="content">
        <p>
            <strong>THIS IS TO CERTIFY</strong> that Mr./Ms./Mrs.
    ...
    <div class="signature-block">
        @if(file_exists(storage_path('app/public/logos/esign_residency.jpeg')))
            <img src="{{ storage_path('app/public/logos/esign_residency.jpeg') }}" alt="" class="esign-img"><br>
        @endif
