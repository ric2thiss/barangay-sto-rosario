...
<head>
    ...
    <style>
        ...
        .sig-name { font-family: "Century Gothic", Arial, sans-serif; font-weight: bold; font-size: 10pt; }
        .sig-title { font-family: "Century Gothic", Arial, sans-serif; font-size: 11pt; }
        .footer-note { margin-top: 30px; font-size: 10pt; font-style: italic; }
    </style>
</head>
<body>
    ...
    <div class="content">
        <p>
            <strong><em>This is to certify that Mr./Ms./Mrs.
            {{ $resident->first_name }} {{ $resident->middle_name }} {{ $resident->surname ?? $resident->last_name }}{{ $resident->suffix ? ', ' . $resident->suffix : '' }},
            {{ $resident->age }} yrs. old, a resident of {{ $resident->purok->purok_name ?? $resident->purok ?? '' }},
            Barangay Sto. Rosario, Magallanes, Agusan del Norte is an indigent member of this barangay and has no permanent source of income.</em></strong>
        </p>
        ...
        <p>
            <strong><u>Issued this {{ now()->format('j') }}{{ now()->format('S') }} day of {{ now()->format('F') }}, {{ now()->year }} at the Office of the Punong Barangay, Barangay Sto. Rosario, Magallanes, Agusan del Norte.</u></strong>
        </p>
    </div>

    {{-- ─── E-SIGNATURE + NAME ──────────────────────── --}}
    <div class="signature-block">
        @if(file_exists(storage_path('app/public/logos/esign_indigent.jpeg')))
            <img src="{{ storage_path('app/public/logos/esign_indigent.jpeg') }}" alt="" class="esign-img"><br>
        @endif
        <span class="sig-name">CLEOPATRA C. ROCES</span>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
