        ...
        <nav class="admin-sidebar-nav">
            <ul>
                @if(in_array($roleName, ['Admin', 'Secretary']))
                    ...
                    <li>
                        <a href="{{ route('certificate-types.index') }}" class="{{ request()->routeIs('certificate-types.*') ? 'active' : '' }}" data-tooltip="Certificate Pricing" wire:navigate>
                ...
                @else
                    ...
                    <li>
                        <a href="{{ route('sso.treasury') }}" class="" data-tooltip="Treasury System" target="_blank">
