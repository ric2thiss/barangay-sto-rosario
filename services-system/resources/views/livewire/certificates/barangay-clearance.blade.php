<div class="max-w-7xl mx-auto py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold">Barangay Clearance Requests</h1>
                            ...
                            <flux:dropdown align="end">
                                ...
                                <flux:menu>
                                    ...
                                    <flux:menu.group label="Export Certificate">
                                        <flux:menu.item href="{{ route('certificates.export', [$request->request_id, 'docx', 'barangay_clearance']) }}" icon="arrow-down-tray" target="_blank">Barangay Clearance (Word)</flux:menu.item>
                                    </flux:menu.group>
