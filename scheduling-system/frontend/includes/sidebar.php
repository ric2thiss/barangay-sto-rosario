  ...
  <div class="container-fluid d-flex align-items-center justify-content-between">
    ...
    <div class="d-flex align-items-center gap-2">
      <div class="d-flex align-items-center bpss-logos">
        <img src="frontend/assets/images/Magallanes-Logo.jpg"
             alt="Municipality Logo"
             class="bpss-logo">
        <img src="frontend/assets/images/seal-nobg.png"
             alt="Barangay Seal"
             class="bpss-logo">
      </div>
    ...
    <div class="dropdown">
      ...
      <button type="button" id="topbarAvatar"
              class="bpss-avatar-toggle dropdown-toggle"
