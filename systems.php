...
<body>
    ...
    <main>
        <div class="page-header">
            ...
            <p>Select a module below to access specific administrative functions and services within the Barangay Management Information System.</p>
        </div>
        ...
        <div class="systems-grid">
            ...
            <a href="profiling-system/" class="system-card" style="border-top-color: #0b3d91;">
                <div class="card-body">
                    ...
                    <p>Manage and maintain comprehensive records of barangay residents, households, and demographics efficiently.</p>
                    <div class="card-footer" style="color: #0b3d91;">Enter Module <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m9 18 6-6-6-6"/></svg></div>
                </div>
            </a>

            <!-- Services System -->
            <a href="services-system/" class="system-card" style="border-top-color: #f57c00;">
                <div class="card-body">
                    ...
                    <p>Process document requests such as barangay clearances, certificates, permits, and other constituent forms.</p>
                    <div class="card-footer" style="color: #f57c00;">Enter Module <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m9 18 6-6-6-6"/></svg></div>
                </div>
            </a>
            ...
            <a href="scheduling-system/" class="system-card" style="border-top-color: #2e7d32;">
                <div class="card-body">
                    ...
                    <p>Organize barangay events, manage facility reservations, schedule meetings, and coordinate local activities.</p>
                    <div class="card-footer" style="color: #2e7d32;">Enter Module <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m9 18 6-6-6-6"/></svg></div>
                </div>
            </a>
            ...
            <a href="attendance-system/" class="system-card" style="border-top-color: #0288d1;">
                <div class="card-body">
                    ...
                    <p>Monitor and track attendance logs for barangay officials, staff, patrols, and community assembly meetings.</p>
                    <div class="card-footer" style="color: #0288d1;">Enter Module <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m9 18 6-6-6-6"/></svg></div>
                </div>
            </a>
            ...
            <a href="treasury-system/" class="system-card" style="border-top-color: #c62828;">
                <div class="card-body">
                    ...
                    <p>Handle financial transactions, manage collection receipts, track budget allocations and monitor expenses.</p>
                    <div class="card-footer" style="color: #c62828;">Enter Module <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m9 18 6-6-6-6"/></svg></div>
                </div>
            </a>
            ...
            <a href="feedback-system/" class="system-card" style="border-top-color: #6a1b9a;">
                <div class="card-body">
                    <div class="icon-wrapper" style="color: #6a1b9a; background-color: rgba(106, 27, 154, 0.1);">
                        <svg class="icon" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 12h-2v-2h2v2zm0-4h-2V6h2v4z"/></svg>
                    </div>
                    <h3 style="color: #6a1b9a;">Feedback System</h3>
                    <p>Receive, process, and act on constituent feedback, grievances, complaints, and suggestions effectively.</p>
                    <div class="card-footer" style="color: #6a1b9a;">Enter Module <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m9 18 6-6-6-6"/></svg></div>
                </div>
            </a>
        </div>
    </main>
    ...
    <footer>
        <p>&copy; <?php echo date('Y'); ?> Barangay Management Information System. All Rights Reserved. Sto. Rosario.</p>
    </footer>
