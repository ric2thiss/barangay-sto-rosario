<div class="max-w-7xl mx-auto py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold">Good Moral Certificate Requests</h1>
                            ...
                            <flux:dropdown align="end">
                                ...
                                <flux:menu>
                                    ...
                                    <flux:menu.group label="Export Certificate">
                                        <flux:menu.item href="{{ route('certificates.export', [$request->request_id, 'docx', 'goodmoral']) }}" icon="arrow-down-tray" target="_blank">Good Moral Certificate (Word)</flux:menu.item>
                                    </flux:menu.group>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-6 text-center text-neutral-500 dark:text-[#cbd5e1]">
                            No good moral certificate requests found.
                        </td>
                    </tr>
                @endforelse
            </tbody>
